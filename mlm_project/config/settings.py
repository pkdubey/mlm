...
SECRET_KEY = 'django-insecure-mlm-secret-key-change-in-production'
...
# Production: switch to PostgreSQL by installing psycopg2-binary and updating below
DATABASES = {
    'default': {
...
# PostgreSQL config (uncomment for production after installing PostgreSQL)
# DATABASES = {
#     'default': {
